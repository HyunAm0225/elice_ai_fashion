# Generated by Django 3.2.3 on 2021-06-10 06:09
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('likeproduct', models.ManyToManyField(blank=True, related_name='like_product', through='products.LikeProduct', to=settings.AUTH_USER_MODEL)),
            ],
            options={
                'verbose_name': '상품',
                'db_table': 'Product',
